...
### **Signed Transformation Function**

The signed transformation is defined as:
...
### **Acetylcholine Gain Equation**

The acetylcholine-modulated sensory precision is given by:
...
### **Norepinephrine Gain Equation**

The norepinephrine-modulated salience gain is given by:
...
### **Dopamine Motivational Bias Equation**

The dopamine-modulated ignition accumulation is given by:
...
### **Serotonin Threshold Offset Equation**

The serotonin-modulated threshold offset is given by:
...
The pairwise phase coherence is given by:
...
### **Synchrony Index Equation**

The level-specific synchrony index is given by:
...
### **Oscillatory Synchrony Gate Falsification Criterion**
...
The competitive inhibition is given by:
...
The optimal ignition occurs when:
...
The level-specific instantaneous salience is given by:
...
### **Global Salience Equation**

The global salience is given by:
...
The leaky metastable ignition accumulation is given by:
...
The metabolic cost function is given by:
...
The informational value function is given by:
...
The discrete-time threshold update with motivational override is given by:
...
### **Bernoulli Sampling Equation**

The stochastic ignition sampling is given by:
...
The reservoir state evolution is given by:
...
The reservoir readout is given by:
...
### **Integrated Salience Equation**

The global salience with reservoir integration is given by:
...
### **Neuromodulatory Mapping Summary**

The four-way neuromodulatory mapping is:
...
The symmetric first-order approximation is given by:
...
| **Signed prediction error φ(ε)** | The **asymmetric nonlinear transformation** of prediction error that preserves **valence polarity** (approach vs. avoidance) — replaces unsigned **\|ε\|** formulation. |
